...
type Printer struct {
	...
	// max x2val
	MaxX2val int32 `json:"MaxX2val,omitempty"`

	// max y2val
	MaxY2val int32 `json:"MaxY2val,omitempty"`
...
func (m *Printer) validateCreatedDateTime(formats strfmt.Registry) error {
...
func (m *Printer) validateUpdatedDateTime(formats strfmt.Registry) error {
