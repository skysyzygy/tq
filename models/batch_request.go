...
func (m *BatchRequest) validateRequests(formats strfmt.Registry) error {
...
func (m *BatchRequest) contextValidateRequests(ctx context.Context, formats strfmt.Registry) error {
