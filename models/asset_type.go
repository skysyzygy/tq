...
func (m *AssetType) validateControlGroup(formats strfmt.Registry) error {
...
func (m *AssetType) validateCreatedDateTime(formats strfmt.Registry) error {
...
func (m *AssetType) validateUpdatedDateTime(formats strfmt.Registry) error {
...
func (m *AssetType) contextValidateControlGroup(ctx context.Context, formats strfmt.Registry) error {
