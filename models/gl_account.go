...
func (m *GlAccount) validateControlGroup(formats strfmt.Registry) error {
...
func (m *GlAccount) validateCreatedDateTime(formats strfmt.Registry) error {
...
func (m *GlAccount) validateUpdatedDateTime(formats strfmt.Registry) error {
...
// ContextValidate validate this gl account based on the context it is used
...
func (m *GlAccount) contextValidateControlGroup(ctx context.Context, formats strfmt.Registry) error {
