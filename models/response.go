...
func init() {
	var res []int32
	if err := json.Unmarshal([]byte(`[100,101,200,201,202,203,204,205,206,300,301,302,303,304,305,306,307,400,401,402,403,404,405,406,407,408,409,410,411,412,413,414,415,416,417,426,500,501,502,503,504,505]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
