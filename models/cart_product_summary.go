...
// CartProductSummary cart product summary
//
// swagger:model CartProductSummary
type CartProductSummary struct {

	// contribution
	Contribution *CartContributionSummary `json:"Contribution,omitempty"`

	// gift certificate
	GiftCertificate *CartGiftCertificate `json:"GiftCertificate,omitempty"`

	// membership
	Membership *CartMembershipSummary `json:"Membership,omitempty"`

	// package
	Package *CartProductPackageSummary `json:"Package,omitempty"`

	// performance
	Performance *CartProductPerformanceSummary `json:"Performance,omitempty"`
	...
	// user defined fee
	UserDefinedFee *UserDefinedFee `json:"UserDefinedFee,omitempty"`
}

// Validate validates this cart product summary
func (m *CartProductSummary) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CartProductSummary) validateContribution(formats strfmt.Registry) error {
...
func (m *CartProductSummary) validateGiftCertificate(formats strfmt.Registry) error {
...
func (m *CartProductSummary) validateMembership(formats strfmt.Registry) error {
...
func (m *CartProductSummary) validatePackage(formats strfmt.Registry) error {
...
func (m *CartProductSummary) validatePerformance(formats strfmt.Registry) error {
...
func (m *CartProductSummary) validateProductClass(formats strfmt.Registry) error {
...
func (m *CartProductSummary) validateUserDefinedFee(formats strfmt.Registry) error {
...
// ContextValidate validate this cart product summary based on the context it is used
func (m *CartProductSummary) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CartProductSummary) contextValidateContribution(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartProductSummary) contextValidateGiftCertificate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartProductSummary) contextValidateMembership(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartProductSummary) contextValidatePackage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartProductSummary) contextValidatePerformance(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartProductSummary) contextValidateProductClass(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartProductSummary) contextValidateUserDefinedFee(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartProductSummary) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CartProductSummary) UnmarshalBinary(b []byte) error {
	var res CartProductSummary
