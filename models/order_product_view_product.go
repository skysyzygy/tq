...
// OrderProductViewProduct order product view product
//
// swagger:model OrderProductViewProduct
type OrderProductViewProduct struct {

	// contribution
	Contribution *OrderProductViewContribution `json:"Contribution,omitempty"`

	// gift certificate
	GiftCertificate *OrderProductViewGiftCertificate `json:"GiftCertificate,omitempty"`

	// membership
	Membership *OrderProductViewMembership `json:"Membership,omitempty"`

	// package
	Package *OrderProductViewProductPackage `json:"Package,omitempty"`

	// performance
	Performance *OrderProductViewProductPerformance `json:"Performance,omitempty"`
	...
	// user defined fee
	UserDefinedFee *OrderProductViewFeeDetail `json:"UserDefinedFee,omitempty"`
}

// Validate validates this order product view product
func (m *OrderProductViewProduct) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OrderProductViewProduct) validateContribution(formats strfmt.Registry) error {
...
func (m *OrderProductViewProduct) validateGiftCertificate(formats strfmt.Registry) error {
...
func (m *OrderProductViewProduct) validateMembership(formats strfmt.Registry) error {
...
func (m *OrderProductViewProduct) validatePackage(formats strfmt.Registry) error {
...
func (m *OrderProductViewProduct) validatePerformance(formats strfmt.Registry) error {
...
func (m *OrderProductViewProduct) validateProductClass(formats strfmt.Registry) error {
...
func (m *OrderProductViewProduct) validateUserDefinedFee(formats strfmt.Registry) error {
...
// ContextValidate validate this order product view product based on the context it is used
func (m *OrderProductViewProduct) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OrderProductViewProduct) contextValidateContribution(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewProduct) contextValidateGiftCertificate(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewProduct) contextValidateMembership(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewProduct) contextValidatePackage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewProduct) contextValidatePerformance(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewProduct) contextValidateProductClass(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewProduct) contextValidateUserDefinedFee(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewProduct) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OrderProductViewProduct) UnmarshalBinary(b []byte) error {
	var res OrderProductViewProduct
