...
func (m *Program) validateControlGroup(formats strfmt.Registry) error {
...
func (m *Program) validateCreatedDateTime(formats strfmt.Registry) error {
...
func (m *Program) validateUpdatedDateTime(formats strfmt.Registry) error {
...
func (m *Program) contextValidateControlGroup(ctx context.Context, formats strfmt.Registry) error {
