...
// Validate validates this web login
func (m *WebLogin) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *WebLogin) validateConstituent(formats strfmt.Registry) error {
...
func (m *WebLogin) validateConstituentUpdateDate(formats strfmt.Registry) error {
...
func (m *WebLogin) validateCreatedDateTime(formats strfmt.Registry) error {
...
func (m *WebLogin) validateEmail(formats strfmt.Registry) error {
...
func (m *WebLogin) validateLastLoginDate(formats strfmt.Registry) error {
...
func (m *WebLogin) validateLockedDate(formats strfmt.Registry) error {
...
func (m *WebLogin) validateLoginType(formats strfmt.Registry) error {
...
func (m *WebLogin) validateUpdatedDateTime(formats strfmt.Registry) error {
...
// ContextValidate validate this web login based on the context it is used
func (m *WebLogin) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *WebLogin) contextValidateConstituent(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WebLogin) contextValidateEmail(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WebLogin) contextValidateLoginType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WebLogin) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *WebLogin) UnmarshalBinary(b []byte) error {
	var res WebLogin
