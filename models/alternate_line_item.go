...
// AlternateLineItem alternate line item
//
// swagger:model AlternateLineItem
type AlternateLineItem struct {
...
// Validate validates this alternate line item
func (m *AlternateLineItem) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AlternateLineItem) validatePackage(formats strfmt.Registry) error {
...
func (m *AlternateLineItem) validatePerformance(formats strfmt.Registry) error {
...
func (m *AlternateLineItem) validateSpecialRequest(formats strfmt.Registry) error {
...
func (m *AlternateLineItem) validateSubLineItems(formats strfmt.Registry) error {
...
// ContextValidate validate this alternate line item based on the context it is used
func (m *AlternateLineItem) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AlternateLineItem) contextValidatePackage(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AlternateLineItem) contextValidatePerformance(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AlternateLineItem) contextValidateSpecialRequest(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AlternateLineItem) contextValidateSubLineItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AlternateLineItem) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AlternateLineItem) UnmarshalBinary(b []byte) error {
	var res AlternateLineItem
