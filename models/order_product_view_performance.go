...
// OrderProductViewPerformance order product view performance
//
// swagger:model OrderProductViewPerformance
type OrderProductViewPerformance struct {

	// best seat map
	BestSeatMap *OrderProductViewBestSeatMap `json:"BestSeatMap,omitempty"`
	...
	// zone map
	ZoneMap *OrderProductViewZoneMap `json:"ZoneMap,omitempty"`
}

// Validate validates this order product view performance
func (m *OrderProductViewPerformance) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OrderProductViewPerformance) validateBestSeatMap(formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) validateFacility(formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) validatePerformanceDateTime(formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) validateProductionSeason(formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) validateSeason(formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) validateTimeSlot(formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) validateType(formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) validateZoneMap(formats strfmt.Registry) error {
...
// ContextValidate validate this order product view performance based on the context it is used
func (m *OrderProductViewPerformance) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OrderProductViewPerformance) contextValidateBestSeatMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) contextValidateFacility(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) contextValidateProductionSeason(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) contextValidateSeason(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) contextValidateTimeSlot(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) contextValidateType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) contextValidateZoneMap(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrderProductViewPerformance) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OrderProductViewPerformance) UnmarshalBinary(b []byte) error {
	var res OrderProductViewPerformance
