...
// CartSubLineItem cart sub line item
//
// swagger:model CartSubLineItem
type CartSubLineItem struct {
	...
	// original price type
	OriginalPriceType *CartPriceType `json:"OriginalPriceType,omitempty"`

	// paid amount
	PaidAmount float64 `json:"PaidAmount,omitempty"`

	// price type
	PriceType *CartPriceType `json:"PriceType,omitempty"`
	...
	SubLineItemDetails []*CartSubLineItemDetail `json:"SubLineItemDetails"`

	// sub line item fees
	SubLineItemFees []*CartFeeDetail `json:"SubLineItemFees"`

	// zone
	Zone *CartZone `json:"Zone,omitempty"`
}

// Validate validates this cart sub line item
func (m *CartSubLineItem) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CartSubLineItem) validateOriginalPriceType(formats strfmt.Registry) error {
...
func (m *CartSubLineItem) validatePriceType(formats strfmt.Registry) error {
...
func (m *CartSubLineItem) validatePricingRule(formats strfmt.Registry) error {
...
func (m *CartSubLineItem) validateRecipient(formats strfmt.Registry) error {
...
func (m *CartSubLineItem) validateSeat(formats strfmt.Registry) error {
...
func (m *CartSubLineItem) validateSubLineItemDetails(formats strfmt.Registry) error {
...
func (m *CartSubLineItem) validateSubLineItemFees(formats strfmt.Registry) error {
...
func (m *CartSubLineItem) validateZone(formats strfmt.Registry) error {
...
// ContextValidate validate this cart sub line item based on the context it is used
func (m *CartSubLineItem) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CartSubLineItem) contextValidateOriginalPriceType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartSubLineItem) contextValidatePriceType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartSubLineItem) contextValidatePricingRule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartSubLineItem) contextValidateRecipient(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartSubLineItem) contextValidateSeat(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartSubLineItem) contextValidateSubLineItemDetails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartSubLineItem) contextValidateSubLineItemFees(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartSubLineItem) contextValidateZone(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CartSubLineItem) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CartSubLineItem) UnmarshalBinary(b []byte) error {
	var res CartSubLineItem
