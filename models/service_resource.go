...
func (m *ServiceResource) validateCreatedDateTime(formats strfmt.Registry) error {
...
func (m *ServiceResource) validateUpdatedDateTime(formats strfmt.Registry) error {
...
// ContextValidate validates this service resource based on context it is used
