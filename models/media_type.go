...
type MediaType struct {
	...
	// generate cost
	GenerateCost float64 `json:"GenerateCost,omitempty"`
...
func (m *MediaType) validateControlGroup(formats strfmt.Registry) error {
...
func (m *MediaType) validateCreatedDateTime(formats strfmt.Registry) error {
...
func (m *MediaType) validateUpdatedDateTime(formats strfmt.Registry) error {
...
func (m *MediaType) contextValidateControlGroup(ctx context.Context, formats strfmt.Registry) error {
