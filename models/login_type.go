...
func (m *LoginType) validateControlGroup(formats strfmt.Registry) error {
...
func (m *LoginType) validateCreatedDateTime(formats strfmt.Registry) error {
...
func (m *LoginType) validateUpdatedDateTime(formats strfmt.Registry) error {
...
// ContextValidate validate this login type based on the context it is used
...
func (m *LoginType) contextValidateControlGroup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LoginType) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LoginType) UnmarshalBinary(b []byte) error {
	var res LoginType
