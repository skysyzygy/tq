...
// WithAliasID adds the aliasID to the aliases delete params
func (o *AliasesDeleteParams) WithAliasID(aliasID string) *AliasesDeleteParams {
	o.SetAliasID(aliasID)
	return o
}

// SetAliasID adds the aliasId to the aliases delete params
func (o *AliasesDeleteParams) SetAliasID(aliasID string) {
	o.AliasID = aliasID
}
