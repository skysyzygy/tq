...
// WithAlias adds the alias to the aliases create params
func (o *AliasesCreateParams) WithAlias(alias *models.Alias) *AliasesCreateParams {
	o.SetAlias(alias)
	return o
}

// SetAlias adds the alias to the aliases create params
func (o *AliasesCreateParams) SetAlias(alias *models.Alias) {
	o.Alias = alias
}
