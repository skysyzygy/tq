...
func (o *SalesLayoutsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /TXN/SalesLayouts/Setup] SalesLayouts_Create", response, response.Code())
	}
}
...
func (o *SalesLayoutsCreateOK) Error() string {
	return fmt.Sprintf("[POST /TXN/SalesLayouts/Setup][%d] salesLayoutsCreateOK  %+v", 200, o.Payload)
}
