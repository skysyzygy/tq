...
func (o *PaymentGatewayCredentialsGetCredentialReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /PaymentGateway/Credentials] PaymentGatewayCredentials_GetCredential", response, response.Code())
	}
}
...
func (o *PaymentGatewayCredentialsGetCredentialOK) Error() string {
	return fmt.Sprintf("[POST /PaymentGateway/Credentials][%d] paymentGatewayCredentialsGetCredentialOK  %+v", 200, o.Payload)
}
