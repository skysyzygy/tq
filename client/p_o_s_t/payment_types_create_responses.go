...
func (o *PaymentTypesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /ReferenceData/PaymentTypes] PaymentTypes_Create", response, response.Code())
	}
}
...
func (o *PaymentTypesCreateOK) Error() string {
	return fmt.Sprintf("[POST /ReferenceData/PaymentTypes][%d] paymentTypesCreateOK  %+v", 200, o.Payload)
}
