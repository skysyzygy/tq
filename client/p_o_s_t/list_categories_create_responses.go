...
func (o *ListCategoriesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /ReferenceData/ListCategories] ListCategories_Create", response, response.Code())
	}
}
...
func (o *ListCategoriesCreateOK) Error() string {
	return fmt.Sprintf("[POST /ReferenceData/ListCategories][%d] listCategoriesCreateOK  %+v", 200, o.Payload)
}
