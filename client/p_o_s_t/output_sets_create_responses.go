...
func (o *OutputSetsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /Reporting/OutputSets] OutputSets_Create", response, response.Code())
	}
}
...
func (o *OutputSetsCreateOK) Error() string {
	return fmt.Sprintf("[POST /Reporting/OutputSets][%d] outputSetsCreateOK  %+v", 200, o.Payload)
}
