...
func (o *EMVCreateLaneReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /PaymentGateway/EMV/TriPosLanes] EMV_CreateLane", response, response.Code())
	}
}
...
func (o *EMVCreateLaneOK) Error() string {
	return fmt.Sprintf("[POST /PaymentGateway/EMV/TriPosLanes][%d] eMVCreateLaneOK  %+v", 200, o.Payload)
}
