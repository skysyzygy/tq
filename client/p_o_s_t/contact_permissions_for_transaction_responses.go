...
func (o *ContactPermissionsForTransactionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /CRM/ContactPermissions/ForTransaction] ContactPermissions_ForTransaction", response, response.Code())
	}
}
...
func (o *ContactPermissionsForTransactionOK) Error() string {
	return fmt.Sprintf("[POST /CRM/ContactPermissions/ForTransaction][%d] contactPermissionsForTransactionOK  %+v", 200, o.Payload)
}
