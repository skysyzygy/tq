...
// GiftAidDocumentStatusesCreateReader is a Reader for the GiftAidDocumentStatusesCreate structure.
type GiftAidDocumentStatusesCreateReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *GiftAidDocumentStatusesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewGiftAidDocumentStatusesCreateOK()
...
// NewGiftAidDocumentStatusesCreateOK creates a GiftAidDocumentStatusesCreateOK with default headers values
func NewGiftAidDocumentStatusesCreateOK() *GiftAidDocumentStatusesCreateOK {
	return &GiftAidDocumentStatusesCreateOK{}
}

/*
GiftAidDocumentStatusesCreateOK describes a response with status code 200, with default header values.

OK
*/
type GiftAidDocumentStatusesCreateOK struct {
	Payload *models.GiftAidDocumentStatus
}

// IsSuccess returns true when this gift aid document statuses create o k response has a 2xx status code
func (o *GiftAidDocumentStatusesCreateOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this gift aid document statuses create o k response has a 3xx status code
func (o *GiftAidDocumentStatusesCreateOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this gift aid document statuses create o k response has a 4xx status code
func (o *GiftAidDocumentStatusesCreateOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this gift aid document statuses create o k response has a 5xx status code
func (o *GiftAidDocumentStatusesCreateOK) IsServerError() bool {
	return false
}

// IsCode returns true when this gift aid document statuses create o k response a status code equal to that given
func (o *GiftAidDocumentStatusesCreateOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the gift aid document statuses create o k response
func (o *GiftAidDocumentStatusesCreateOK) Code() int {
	return 200
}
