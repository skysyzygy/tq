...
func (o *AuthenticateGenerateTokenReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /Security/Authenticate/Token/Generate] Authenticate_GenerateToken", response, response.Code())
	}
}
...
func (o *AuthenticateGenerateTokenOK) Error() string {
	return fmt.Sprintf("[POST /Security/Authenticate/Token/Generate][%d] authenticateGenerateTokenOK  %+v", 200, o.Payload)
}
