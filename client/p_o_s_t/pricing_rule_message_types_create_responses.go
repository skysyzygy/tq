...
func (o *PricingRuleMessageTypesCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /ReferenceData/PricingRuleMessageTypes] PricingRuleMessageTypes_Create", response, response.Code())
	}
}
...
func (o *PricingRuleMessageTypesCreateOK) Error() string {
	return fmt.Sprintf("[POST /ReferenceData/PricingRuleMessageTypes][%d] pricingRuleMessageTypesCreateOK  %+v", 200, o.Payload)
}
