...
func (o *InventoryWebContentsCreateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewInventoryWebContentsCreateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *InventoryWebContentsCreateOK) Error() string {
	...
	return fmt.Sprintf("[POST /Txn/InventoryWebContents][%d] inventoryWebContentsCreateOK %s", 200, payload)
}
...
// NewInventoryWebContentsCreateDefault creates a InventoryWebContentsCreateDefault with default headers values
func NewInventoryWebContentsCreateDefault(code int) *InventoryWebContentsCreateDefault {
	return &InventoryWebContentsCreateDefault{
		_statusCode: code,
	}
}

/*
InventoryWebContentsCreateDefault describes a response with status code -1, with default header values.

Error
*/
type InventoryWebContentsCreateDefault struct {
	_statusCode int

	Payload *models.ErrorMessage
}

// IsSuccess returns true when this inventory web contents create default response has a 2xx status code
func (o *InventoryWebContentsCreateDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this inventory web contents create default response has a 3xx status code
func (o *InventoryWebContentsCreateDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this inventory web contents create default response has a 4xx status code
func (o *InventoryWebContentsCreateDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this inventory web contents create default response has a 5xx status code
func (o *InventoryWebContentsCreateDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this inventory web contents create default response a status code equal to that given
func (o *InventoryWebContentsCreateDefault) IsCode(code int) bool {
	return o._statusCode == code
}

// Code gets the status code for the inventory web contents create default response
func (o *InventoryWebContentsCreateDefault) Code() int {
	return o._statusCode
}

func (o *InventoryWebContentsCreateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /Txn/InventoryWebContents][%d] InventoryWebContents_Create default %s", o._statusCode, payload)
}

func (o *InventoryWebContentsCreateDefault) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /Txn/InventoryWebContents][%d] InventoryWebContents_Create default %s", o._statusCode, payload)
}

func (o *InventoryWebContentsCreateDefault) GetPayload() *models.ErrorMessage {
	return o.Payload
}

func (o *InventoryWebContentsCreateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
