...
func (o *AuthorizationFinalizeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /PaymentGateway/Authorization/Finalize] Authorization_Finalize", response, response.Code())
	}
}
...
func (o *AuthorizationFinalizeOK) Error() string {
	return fmt.Sprintf("[POST /PaymentGateway/Authorization/Finalize][%d] authorizationFinalizeOK  %+v", 200, o.Payload)
}
