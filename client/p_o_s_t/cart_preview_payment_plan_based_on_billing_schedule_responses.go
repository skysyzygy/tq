...
// CartPreviewPaymentPlanBasedOnBillingScheduleReader is a Reader for the CartPreviewPaymentPlanBasedOnBillingSchedule structure.
type CartPreviewPaymentPlanBasedOnBillingScheduleReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *CartPreviewPaymentPlanBasedOnBillingScheduleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewCartPreviewPaymentPlanBasedOnBillingScheduleOK()
...
// NewCartPreviewPaymentPlanBasedOnBillingScheduleOK creates a CartPreviewPaymentPlanBasedOnBillingScheduleOK with default headers values
func NewCartPreviewPaymentPlanBasedOnBillingScheduleOK() *CartPreviewPaymentPlanBasedOnBillingScheduleOK {
	return &CartPreviewPaymentPlanBasedOnBillingScheduleOK{}
}

/*
CartPreviewPaymentPlanBasedOnBillingScheduleOK describes a response with status code 200, with default header values.

OK
*/
type CartPreviewPaymentPlanBasedOnBillingScheduleOK struct {
	Payload []*models.PaymentPlanPreview
}

// IsSuccess returns true when this cart preview payment plan based on billing schedule o k response has a 2xx status code
func (o *CartPreviewPaymentPlanBasedOnBillingScheduleOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this cart preview payment plan based on billing schedule o k response has a 3xx status code
func (o *CartPreviewPaymentPlanBasedOnBillingScheduleOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this cart preview payment plan based on billing schedule o k response has a 4xx status code
func (o *CartPreviewPaymentPlanBasedOnBillingScheduleOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this cart preview payment plan based on billing schedule o k response has a 5xx status code
func (o *CartPreviewPaymentPlanBasedOnBillingScheduleOK) IsServerError() bool {
	return false
}

// IsCode returns true when this cart preview payment plan based on billing schedule o k response a status code equal to that given
func (o *CartPreviewPaymentPlanBasedOnBillingScheduleOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the cart preview payment plan based on billing schedule o k response
func (o *CartPreviewPaymentPlanBasedOnBillingScheduleOK) Code() int {
	return 200
}
...
func (o *CartPreviewPaymentPlanBasedOnBillingScheduleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
