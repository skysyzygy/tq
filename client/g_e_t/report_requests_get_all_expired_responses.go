...
func (o *ReportRequestsGetAllExpiredReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /Reporting/ReportRequests/Expired] ReportRequests_GetAllExpired", response, response.Code())
	}
}
...
func (o *ReportRequestsGetAllExpiredOK) Error() string {
	return fmt.Sprintf("[GET /Reporting/ReportRequests/Expired][%d] reportRequestsGetAllExpiredOK  %+v", 200, o.Payload)
}
