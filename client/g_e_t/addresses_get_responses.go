...
func (o *AddressesGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /CRM/Addresses/{addressId}] Addresses_Get", response, response.Code())
	}
}
...
func (o *AddressesGetOK) Error() string {
	return fmt.Sprintf("[GET /CRM/Addresses/{addressId}][%d] addressesGetOK  %+v", 200, o.Payload)
}
