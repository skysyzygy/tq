...
func (o *DocumentsGetAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /Finance/Documents] Documents_GetAll", response, response.Code())
	}
}
...
func (o *DocumentsGetAllOK) Error() string {
	return fmt.Sprintf("[GET /Finance/Documents][%d] documentsGetAllOK  %+v", 200, o.Payload)
}
