...
func (o *InvoiceBillingStatusReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /TXN/InvoiceBilling/{id}/Status] InvoiceBilling_Status", response, response.Code())
	}
}
...
func (o *InvoiceBillingStatusOK) Error() string {
	return fmt.Sprintf("[GET /TXN/InvoiceBilling/{id}/Status][%d] invoiceBillingStatusOK  %+v", 200, o.Payload)
}
