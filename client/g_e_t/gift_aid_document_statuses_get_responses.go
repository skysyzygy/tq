...
func (o *GiftAidDocumentStatusesGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/GiftAidDocumentStatuses/{id}] GiftAidDocumentStatuses_Get", response, response.Code())
	}
}
...
func (o *GiftAidDocumentStatusesGetOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/GiftAidDocumentStatuses/{id}][%d] giftAidDocumentStatusesGetOK  %+v", 200, o.Payload)
}
