...
func (o *PortfoliosGetPortfolioEntryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /Finance/Portfolios/Entries] Portfolios_GetPortfolioEntry", response, response.Code())
	}
}
...
func (o *PortfoliosGetPortfolioEntryOK) Error() string {
	return fmt.Sprintf("[GET /Finance/Portfolios/Entries][%d] portfoliosGetPortfolioEntryOK  %+v", 200, o.Payload)
}
