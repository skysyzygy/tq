...
func (o *CountriesGetAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/Countries] Countries_GetAll", response, response.Code())
	}
}
...
func (o *CountriesGetAllOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/Countries][%d] countriesGetAllOK  %+v", 200, o.Payload)
}
