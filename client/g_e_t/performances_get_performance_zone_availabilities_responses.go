...
func (o *PerformancesGetPerformanceZoneAvailabilitiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /TXN/Performances/Zones] Performances_GetPerformanceZoneAvailabilities", response, response.Code())
	}
}
...
func (o *PerformancesGetPerformanceZoneAvailabilitiesOK) Error() string {
	return fmt.Sprintf("[GET /TXN/Performances/Zones][%d] performancesGetPerformanceZoneAvailabilitiesOK  %+v", 200, o.Payload)
}
