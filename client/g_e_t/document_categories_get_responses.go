...
func (o *DocumentCategoriesGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/DocumentCategories/{id}] DocumentCategories_Get", response, response.Code())
	}
}
...
func (o *DocumentCategoriesGetOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/DocumentCategories/{id}][%d] documentCategoriesGetOK  %+v", 200, o.Payload)
}
