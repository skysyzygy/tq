...
func (o *HoldCodeCategoriesGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/HoldCodeCategories/{id}] HoldCodeCategories_Get", response, response.Code())
	}
}
...
func (o *HoldCodeCategoriesGetOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/HoldCodeCategories/{id}][%d] holdCodeCategoriesGetOK  %+v", 200, o.Payload)
}
