...
func (o *EmailProfilesGetAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/EmailProfiles] EmailProfiles_GetAll", response, response.Code())
	}
}
...
func (o *EmailProfilesGetAllOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/EmailProfiles][%d] emailProfilesGetAllOK  %+v", 200, o.Payload)
}
