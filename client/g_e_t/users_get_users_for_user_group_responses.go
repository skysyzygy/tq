...
func (o *UsersGetUsersForUserGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /Security/Users/ForGroup] Users_GetUsersForUserGroup", response, response.Code())
	}
}
...
func (o *UsersGetUsersForUserGroupOK) Error() string {
	return fmt.Sprintf("[GET /Security/Users/ForGroup][%d] usersGetUsersForUserGroupOK  %+v", 200, o.Payload)
}
