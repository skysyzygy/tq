...
func (o *ReportRequestsGetAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /Reporting/ReportRequests] ReportRequests_GetAll", response, response.Code())
	}
}
...
func (o *ReportRequestsGetAllOK) Error() string {
	return fmt.Sprintf("[GET /Reporting/ReportRequests][%d] reportRequestsGetAllOK  %+v", 200, o.Payload)
}
