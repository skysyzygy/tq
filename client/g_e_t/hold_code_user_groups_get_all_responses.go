...
func (o *HoldCodeUserGroupsGetAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /TXN/HoldCodeUserGroups] HoldCodeUserGroups_GetAll", response, response.Code())
	}
}
...
func (o *HoldCodeUserGroupsGetAllOK) Error() string {
	return fmt.Sprintf("[GET /TXN/HoldCodeUserGroups][%d] holdCodeUserGroupsGetAllOK  %+v", 200, o.Payload)
}
