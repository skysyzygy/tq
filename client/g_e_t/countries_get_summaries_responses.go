...
func (o *CountriesGetSummariesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/Countries/Summary] Countries_GetSummaries", response, response.Code())
	}
}
...
func (o *CountriesGetSummariesOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/Countries/Summary][%d] countriesGetSummariesOK  %+v", 200, o.Payload)
}
