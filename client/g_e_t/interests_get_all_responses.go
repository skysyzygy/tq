...
func (o *InterestsGetAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /CRM/Interests] Interests_GetAll", response, response.Code())
	}
}
...
func (o *InterestsGetAllOK) Error() string {
	return fmt.Sprintf("[GET /CRM/Interests][%d] interestsGetAllOK  %+v", 200, o.Payload)
}
