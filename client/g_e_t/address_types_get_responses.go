...
func (o *AddressTypesGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/AddressTypes/{id}] AddressTypes_Get", response, response.Code())
	}
}
...
func (o *AddressTypesGetOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/AddressTypes/{id}][%d] addressTypesGetOK  %+v", 200, o.Payload)
}
