...
func (o *OrganizationsGetSummariesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/Organizations/Summary] Organizations_GetSummaries", response, response.Code())
	}
}
...
func (o *OrganizationsGetSummariesOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/Organizations/Summary][%d] organizationsGetSummariesOK  %+v", 200, o.Payload)
}
