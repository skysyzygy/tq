...
func (o *DonationLevelsGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/DonationLevels/{id}] DonationLevels_Get", response, response.Code())
	}
}
...
func (o *DonationLevelsGetOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/DonationLevels/{id}][%d] donationLevelsGetOK  %+v", 200, o.Payload)
}
