...
func (o *AccountTypesGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/AccountTypes/{id}] AccountTypes_Get", response, response.Code())
	}
}
...
func (o *AccountTypesGetOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/AccountTypes/{id}][%d] accountTypesGetOK  %+v", 200, o.Payload)
}
