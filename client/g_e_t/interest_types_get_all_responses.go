...
func (o *InterestTypesGetAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/InterestTypes] InterestTypes_GetAll", response, response.Code())
	}
}
...
func (o *InterestTypesGetAllOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/InterestTypes][%d] interestTypesGetAllOK  %+v", 200, o.Payload)
}
