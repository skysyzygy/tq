...
func (o *SpecialActivityStatusesGetAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/SpecialActivityStatuses] SpecialActivityStatuses_GetAll", response, response.Code())
	}
}
...
func (o *SpecialActivityStatusesGetAllOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/SpecialActivityStatuses][%d] specialActivityStatusesGetAllOK  %+v", 200, o.Payload)
}
