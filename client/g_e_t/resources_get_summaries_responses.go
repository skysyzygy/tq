...
// ResourcesGetSummariesReader is a Reader for the ResourcesGetSummaries structure.
type ResourcesGetSummariesReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *ResourcesGetSummariesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewResourcesGetSummariesOK()
...
// NewResourcesGetSummariesOK creates a ResourcesGetSummariesOK with default headers values
func NewResourcesGetSummariesOK() *ResourcesGetSummariesOK {
	return &ResourcesGetSummariesOK{}
}

/*
ResourcesGetSummariesOK describes a response with status code 200, with default header values.

OK
*/
type ResourcesGetSummariesOK struct {
	Payload []*models.ResourceSummary
}

// IsSuccess returns true when this resources get summaries o k response has a 2xx status code
func (o *ResourcesGetSummariesOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this resources get summaries o k response has a 3xx status code
func (o *ResourcesGetSummariesOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this resources get summaries o k response has a 4xx status code
func (o *ResourcesGetSummariesOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this resources get summaries o k response has a 5xx status code
func (o *ResourcesGetSummariesOK) IsServerError() bool {
	return false
}

// IsCode returns true when this resources get summaries o k response a status code equal to that given
func (o *ResourcesGetSummariesOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the resources get summaries o k response
func (o *ResourcesGetSummariesOK) Code() int {
	return 200
}
...
func (o *ResourcesGetSummariesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
