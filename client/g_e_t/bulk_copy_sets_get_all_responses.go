...
func (o *BulkCopySetsGetAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /TXN/BulkCopySets] BulkCopySets_GetAll", response, response.Code())
	}
}
...
func (o *BulkCopySetsGetAllOK) Error() string {
	return fmt.Sprintf("[GET /TXN/BulkCopySets][%d] bulkCopySetsGetAllOK  %+v", 200, o.Payload)
}
