...
func (o *CrediteeTypesGetAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/CrediteeTypes] CrediteeTypes_GetAll", response, response.Code())
	}
}
...
func (o *CrediteeTypesGetAllOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/CrediteeTypes][%d] crediteeTypesGetAllOK  %+v", 200, o.Payload)
}
