...
func (o *PlanPrioritiesGetAllReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/PlanPriorities] PlanPriorities_GetAll", response, response.Code())
	}
}
...
func (o *PlanPrioritiesGetAllOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/PlanPriorities][%d] planPrioritiesGetAllOK  %+v", 200, o.Payload)
}
