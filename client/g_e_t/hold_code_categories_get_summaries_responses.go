...
func (o *HoldCodeCategoriesGetSummariesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/HoldCodeCategories/Summary] HoldCodeCategories_GetSummaries", response, response.Code())
	}
}
...
func (o *HoldCodeCategoriesGetSummariesOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/HoldCodeCategories/Summary][%d] holdCodeCategoriesGetSummariesOK  %+v", 200, o.Payload)
}
