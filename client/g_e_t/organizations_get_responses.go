...
func (o *OrganizationsGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /ReferenceData/Organizations/{id}] Organizations_Get", response, response.Code())
	}
}
...
func (o *OrganizationsGetOK) Error() string {
	return fmt.Sprintf("[GET /ReferenceData/Organizations/{id}][%d] organizationsGetOK  %+v", 200, o.Payload)
}
