...
func (o *PriceTemplatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /TXN/PriceTemplates/{priceTemplateId}] PriceTemplates_Update", response, response.Code())
	}
}
...
func (o *PriceTemplatesUpdateOK) Error() string {
	return fmt.Sprintf("[PUT /TXN/PriceTemplates/{priceTemplateId}][%d] priceTemplatesUpdateOK  %+v", 200, o.Payload)
}
