...
func (o *PriceTypeUserGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /TXN/PriceTypeUserGroups/{priceTypeUserGroupId}] PriceTypeUserGroups_Update", response, response.Code())
	}
}
...
func (o *PriceTypeUserGroupsUpdateOK) Error() string {
	return fmt.Sprintf("[PUT /TXN/PriceTypeUserGroups/{priceTypeUserGroupId}][%d] priceTypeUserGroupsUpdateOK  %+v", 200, o.Payload)
}
