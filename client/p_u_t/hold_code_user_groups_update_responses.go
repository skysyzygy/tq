...
func (o *HoldCodeUserGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /TXN/HoldCodeUserGroups/{holdCodeUserGroupId}] HoldCodeUserGroups_Update", response, response.Code())
	}
}
...
func (o *HoldCodeUserGroupsUpdateOK) Error() string {
	return fmt.Sprintf("[PUT /TXN/HoldCodeUserGroups/{holdCodeUserGroupId}][%d] holdCodeUserGroupsUpdateOK  %+v", 200, o.Payload)
}
