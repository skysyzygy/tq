...
func (o *AddressesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /CRM/Addresses/{addressId}] Addresses_Update", response, response.Code())
	}
}
...
func (o *AddressesUpdateOK) Error() string {
	return fmt.Sprintf("[PUT /CRM/Addresses/{addressId}][%d] addressesUpdateOK  %+v", 200, o.Payload)
}
