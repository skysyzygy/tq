...
func (o *PriceLayerTypesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /ReferenceData/PriceLayerTypes/{id}] PriceLayerTypes_Update", response, response.Code())
	}
}
...
func (o *PriceLayerTypesUpdateOK) Error() string {
	return fmt.Sprintf("[PUT /ReferenceData/PriceLayerTypes/{id}][%d] priceLayerTypesUpdateOK  %+v", 200, o.Payload)
}
