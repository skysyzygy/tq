...
func (o *GiftAidRatesUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /ReferenceData/GiftAidRates/{id}] GiftAidRates_Update", response, response.Code())
	}
}
...
func (o *GiftAidRatesUpdateOK) Error() string {
	return fmt.Sprintf("[PUT /ReferenceData/GiftAidRates/{id}][%d] giftAidRatesUpdateOK  %+v", 200, o.Payload)
}
