...
// WithAlias adds the alias to the aliases update params
func (o *AliasesUpdateParams) WithAlias(alias *models.Alias) *AliasesUpdateParams {
	o.SetAlias(alias)
	return o
}

// SetAlias adds the alias to the aliases update params
func (o *AliasesUpdateParams) SetAlias(alias *models.Alias) {
	o.Alias = alias
}

// WithAliasID adds the aliasID to the aliases update params
func (o *AliasesUpdateParams) WithAliasID(aliasID string) *AliasesUpdateParams {
	o.SetAliasID(aliasID)
	return o
}

// SetAliasID adds the aliasId to the aliases update params
func (o *AliasesUpdateParams) SetAliasID(aliasID string) {
	o.AliasID = aliasID
}
