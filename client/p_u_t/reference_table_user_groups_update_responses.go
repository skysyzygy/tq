...
func (o *ReferenceTableUserGroupsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /ReferenceData/ReferenceTableUserGroups/{id}] ReferenceTableUserGroups_Update", response, response.Code())
	}
}
...
func (o *ReferenceTableUserGroupsUpdateOK) Error() string {
	return fmt.Sprintf("[PUT /ReferenceData/ReferenceTableUserGroups/{id}][%d] referenceTableUserGroupsUpdateOK  %+v", 200, o.Payload)
}
