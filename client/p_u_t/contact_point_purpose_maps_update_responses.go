...
func (o *ContactPointPurposeMapsUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /CRM/ContactPointPurposeMaps/{contactPointPurposeMapId}] ContactPointPurposeMaps_Update", response, response.Code())
	}
}
...
func (o *ContactPointPurposeMapsUpdateOK) Error() string {
	return fmt.Sprintf("[PUT /CRM/ContactPointPurposeMaps/{contactPointPurposeMapId}][%d] contactPointPurposeMapsUpdateOK  %+v", 200, o.Payload)
}
