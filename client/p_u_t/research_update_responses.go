...
// ResearchUpdateReader is a Reader for the ResearchUpdate structure.
type ResearchUpdateReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *ResearchUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewResearchUpdateOK()
...
// NewResearchUpdateOK creates a ResearchUpdateOK with default headers values
func NewResearchUpdateOK() *ResearchUpdateOK {
	return &ResearchUpdateOK{}
}

/*
ResearchUpdateOK describes a response with status code 200, with default header values.

OK
*/
type ResearchUpdateOK struct {
	Payload *models.ResearchEntry
}

// IsSuccess returns true when this research update o k response has a 2xx status code
func (o *ResearchUpdateOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this research update o k response has a 3xx status code
func (o *ResearchUpdateOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this research update o k response has a 4xx status code
func (o *ResearchUpdateOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this research update o k response has a 5xx status code
func (o *ResearchUpdateOK) IsServerError() bool {
	return false
}

// IsCode returns true when this research update o k response a status code equal to that given
func (o *ResearchUpdateOK) IsCode(code int) bool {
	return code == 200
}

// Code gets the status code for the research update o k response
func (o *ResearchUpdateOK) Code() int {
	return 200
}
