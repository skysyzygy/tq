...
var Post_AccountTypes_cmd = &cobra.Command{
		Use: `AccountTypes`,
		Example: tq.JSONHighlight(`{"CardLength":"string", "CardPrefix":"string", "CardtypeIndicator":"string", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "EditMask":"string", "Id":123, "Inactive":true, "Mod10Indicator":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Accounts_cmd = &cobra.Command{
		Use: `Accounts`,
		Example: tq.JSONHighlight(`{"AccountNumber":"string", "CardExpiryMonth":123, "CardExpiryYear":123, "ConstituentId":123, "ExclusiveToControlledBatchId":123, "Inactive":true, "Name":"string", "PaymentMethodGroupId":123, "ReturnAccountIfAccountExists":true, "TransactionOrigin":"string", "VantivEncryptedCard":{"Version":"string"}}`),
...
var Post_ActionTypes_cmd = &cobra.Command{
		Use: `ActionTypes`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "LetterIndicator":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ActivityCategories_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"AutoClose":true, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ActivityTypes_cmd = &cobra.Command{
		Use: `ActivityTypes`,
		Example: tq.JSONHighlight(`{"Category":{"Id":123}, "ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "PerfIndicator":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_AddressTypes_cmd = &cobra.Command{
		Use: `AddressTypes`,
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Aliases_cmd = &cobra.Command{
		Use: `Aliases`,
		Example: tq.JSONHighlight(`{"AliasFirstName":"string", "AliasLastName":"string", "AliasType":{"Id":123}, "Constituent":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EditIndicator":true, "Id":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_AnalyticsReports_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Division":{"Id":"string"}, "Id":123, "Inactive":true, "ReportPath":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_AppealCategories_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Artists_cmd = &cobra.Command{
		Use: `Artists`,
		Example: tq.JSONHighlight(`{"Bio":"string", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "FirstName":"string", "Id":123, "LastName":"string", "MiddleName":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "VoiceId":123}`),
...
var Post_Assets_cmd = &cobra.Command{
		Use: `Assets`,
		Example: tq.JSONHighlight(`{"AcquisitionDateTime":"2000-01-01T00:00:00.000Z", "AssetType":{"Id":123}, "Constituent":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "EditIndicator":true, "EstimatedValue":123.456, "Id":123, "Notes":"string", "SaleDateTime":"2000-01-01T00:00:00.000Z", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Attributes_cmd = &cobra.Command{
		Use: `Attributes`,
		Example: tq.JSONHighlight(`{"Constituent":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EditIndicator":true, "Id":123, "Keyword":{"Id":123}, "KeywordConstituentType":{"Inactive":true, "Rank":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "Value":"string"}`),
...
var Post_Authenticate_cmd = &cobra.Command{
		Use: `Authenticate`,
		Example: tq.JSONHighlight(`{"Application":"string", "MachineLocation":"string", "Password":"string", "UserGroup":"string", "UserName":"string"}`),
...
var Post_Batch_cmd = &cobra.Command{
		Use: `Batch`,
		Example: tq.JSONHighlight(`{"Requests":[{"Id":123}, ...]}`),
		Short: ``,
		Long:  ``,
		PreRunE: initTq,
		RunE: func(cmd *cobra.Command, args []string) (err error) {
...
var Post_BatchTypes_cmd = &cobra.Command{
		Use: `BatchTypes`,
		Example: tq.JSONHighlight(`{"BatchTypeGroup":{"Id":123}, "BusinessUnit":{"Id":123}, "Category":123, "CntlIndicator":true, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_BillingSchedules_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"BillAmounts":"string", "BillDates":"string", "ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "LongDescription":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_BillingTypes_cmd = &cobra.Command{
		Use: `BillingTypes`,
		Example: tq.JSONHighlight(`{"AutoBillingIndicator":"string", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_BookingCategories_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "EditIndicator":true, "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_BulkDailyCopyExclusions_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DoNotCopy":true, "Id":123, "IncludeWithoutCopy":true, "PackageId":123, "PerformanceId":123, "SetId":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_CampaignDesignations_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"Campaign":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DefaultIndicator":true, "Designation":{"Id":123}, "EditIndicator":true, "GoalAmount":123.456, "Id":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Cart_cmd = &cobra.Command{
		Use: `Cart`,
		Example: tq.JSONHighlight(`{"BookingId":123, "SessionKey":"string"}`),
...
var Post_Colors_cmd = &cobra.Command{
		Use: `Colors`,
		Example: tq.JSONHighlight(`{"ColorValue":123, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Composers_cmd = &cobra.Command{
		Use: `Composers`,
		Example: tq.JSONHighlight(`{"Bio":"string", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "FirstName":"string", "Id":123, "Inactive":true, "LastName":"string", "MiddleName":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Constituencies_cmd = &cobra.Command{
		Use: `Constituencies`,
		Example: tq.JSONHighlight(`{"ConstituencyType":{"Id":123}, "Constituent":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EditIndicator":true, "EndDate":"2000-01-01T00:00:00.000Z", "Id":123, "StartDate":"2000-01-01T00:00:00.000Z", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ConstituencyTypes_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "Rank":123, "ShortDescription":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ConstituentDocuments_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"Category":{"Id":123}, "ConstituentId":123, "Contents":"AA==", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "FileName":"string", "Id":123, "Notes":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ConstituentTypeAffiliates_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"AffiliationType":{"Id":123}, "ConstituentType":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "HouseholdPrimary":true, "Id":123, "Rank":123, "ShowWithGroup":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ContactPermissionCategories_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"AskFrequencyMonths":123, "ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ContactPermissions_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"Answer":"string", "Constituent":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EditIndicator":true, "Id":123, "LastAskedDateTime":"2000-01-01T00:00:00.000Z", "ShouldAsk":true, "Type":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ContactPointCategories_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ContactPointKey":"string", "ContactPointTable":"string", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ContactPointCategoryPurposes_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ContactPointCategory":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "Purpose":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ContactPointPurposeMaps_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ContactPoint":{"Id":123}, "ContactPointCategory":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EditIndicator":true, "Id":123, "Purpose":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ContactPointPurposes_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "PurposeCategory":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
		Short: `Create a new contact point purpose`,
		Long:  `Create a new contact point purpose.`,
		PreRunE: initTq,
		RunE: func(cmd *cobra.Command, args []string) (err error) {
...
var Post_ContributionDesignations_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "LetterText":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ControlGroupUserGroups_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DefaultIndicator":true, "EditIndicator":true, "Id":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "UserGroupId":"string"}`),
...
var Post_ControlGroups_cmd = &cobra.Command{
		Use: `ControlGroups`,
		Example: tq.JSONHighlight(`{"CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "Permission":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_CoreIdentity_cmd = &cobra.Command{
		Use: `CoreIdentity`,
		Example: tq.JSONHighlight(`{"Body":"string", "Headers":[{"Name":"string", "Value":"string"}, ...], "Method":"string", "Path":"string", "QueryParameters":[{"Name":"string", "Value":"string"}, ...]}`),
		Short: ``,
		Long:  ``,
		PreRunE: initTq,
		RunE: func(cmd *cobra.Command, args []string) (err error) {
...
var Post_CrediteeTypes_cmd = &cobra.Command{
		Use: `CrediteeTypes`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "CreditMembershipIndicator":true, "Description":"string", "GiftAidIndicator":true, "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_CurrencyTypes_cmd = &cobra.Command{
		Use: `CurrencyTypes`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "Rate":123.456, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Custom_cmd = &cobra.Command{
		Use: `Custom`,
		Example: tq.JSONHighlight(`{"ParameterValues":[{"Name":"string", "Value":"string"}, ...], "Parameters":"string", "ProcedureId":123, "ProcedureName":"string"}`),
...
var Post_CustomDefaults_cmd = &cobra.Command{
		Use: `CustomDefaults`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "CustomDefaultCategory":{"Id":123}, "DefaultValue":"string", "Description":"string", "FieldName":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_DeliveryMethods_cmd = &cobra.Command{
		Use: `DeliveryMethods`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "PrintAtHome":true, "RequireAddress":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Diagnostics_cmd = &cobra.Command{
		Use: `Diagnostics`,
		Example: tq.JSONHighlight(`{"ServerName":"string"}`),
...
var Post_DiscountTypes_cmd = &cobra.Command{
		Use: `DiscountTypes`,
		Example: tq.JSONHighlight(`{"Amount":123.456, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "PercentIndicator":true, "RespectMinimumPrice":true, "ShortDescription":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_DocumentCategories_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "ParentTableName":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_DonationLevels_cmd = &cobra.Command{
		Use: `DonationLevels`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "ProgramType":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_EMV_cmd = &cobra.Command{
		Use: `EMV`,
		Example: tq.JSONHighlight(`{"Amount":123.456, "BillingAddress":{"AddressId":123, "Country":"string", "PostalCode":"string", "Street1":"string"}, "ConstituentId":123, "IsMoto":true, "MachineId":123, "PaymentId":123, "StoreAccount":true, "TransactionOrigin":"string", "UserData":"string"}`),
...
var Post_ElectronicAddressTypes_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "IsEmail":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_EmailResponses_cmd = &cobra.Command{
		Use: `EmailResponses`,
		Example: tq.JSONHighlight(`{"ConstituentId":123, "DownloadNumber":123, "EventDateTime":"2000-01-01T00:00:00.000Z", "EventName":"string"}`),
...
var Post_Emails_cmd = &cobra.Command{
		Use: `Emails`,
		Example: tq.JSONHighlight(`{"Attachments":[{"Name":"string"}, ...], "DuplicateBodyAsAttachment":true, "DuplicateBodyAttachmentName":"string", "EmailProfileId":123, "EmbeddedImages":[{"MediaType":"string", "Name":"string"}, ...], "FromAddress":"string", "HtmlBody":"string", "PlainTextBody":"string", "RecipientAddress":"string", "Subject":"string"}`),
...
var Post_Facilities_cmd = &cobra.Command{
		Use: `Facilities`,
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DefaultBestSeatMapId":123, "DefaultZoneMapId":123, "Description":"string", "Id":123, "SeatMap":{"Id":123}, "Theater":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Genders_cmd = &cobra.Command{
		Use: `Genders`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DefaultPrefix":{"Id":123}, "Description":"string", "Id":123, "Inactive":true, "ShortDescription":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_GiftAidRates_cmd = &cobra.Command{
		Use: `GiftAidRates`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EndDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "Rate":123.456, "StartDateTime":"2000-01-01T00:00:00.000Z", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_GiftAidTypes_cmd = &cobra.Command{
		Use: `GiftAidTypes`,
		Example: tq.JSONHighlight(`{"CharityClaimsRef":"string", "ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_GiftCertificates_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"BatchId":123, "LockForBatch":true, "Number":"string", "PaymentMethodId":123}`),
...
var Post_HoldCodeUserGroups_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "HoldCode":{"Id":123}, "Id":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "UserGroupId":"string"}`),
...
var Post_HoldCodes_cmd = &cobra.Command{
		Use: `HoldCodes`,
		Example: tq.JSONHighlight(`{"BlackoutIndicator":true, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "EditIndicator":true, "Id":123, "Legend":"string", "Type":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_IntegrationDefaults_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"AccessId":"string", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DefaultValue":"string", "Description":"string", "FieldName":"string", "Id":123, "Integration":{"Id":123}, "Organization":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Integrations_cmd = &cobra.Command{
		Use: `Integrations`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
		Short: `Create a new action type`,
		Long:  `Create a new action type.`,
		PreRunE: initTq,
		RunE: func(cmd *cobra.Command, args []string) (err error) {
...
var Post_InterestTypes_cmd = &cobra.Command{
		Use: `InterestTypes`,
		Example: tq.JSONHighlight(`{"Category":{"Id":123}, "ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "SearchIndicator":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "UsedIn":"string"}`),
...
var Post_Interests_cmd = &cobra.Command{
		Use: `Interests`,
		Example: tq.JSONHighlight(`{"Constituent":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EditIndicator":true, "Id":123, "InterestType":{"Id":123}, "Selected":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "Weight":123}`),
...
var Post_InventoryContactPermissionTypes_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ContactPermissionType":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "ProductionElementId":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_InventoryWebContents_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ContentType":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "ProductionElementId":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "Value":"string"}`),
...
var Post_MediaTypes_cmd = &cobra.Command{
		Use: `MediaTypes`,
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "GenerateCost":123.456, "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ModeOfSaleCategories_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "Sequence":123, "ShortDescription":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ModeOfSalePriceTypes_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DefaultIndicator":true, "Id":123, "ModeOfSale":{"Id":123}, "PriceType":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ModeOfSaleSurveyQuestions_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "ModeOfSale":{"Id":123}, "Question":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ModeOfSaleUserGroups_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DefaultIndicator":true, "Id":123, "ModeOfSale":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "UserGroupId":"string"}`),
...
var Post_ObjectPermissions_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ApplicationObject":{"Id":123}, "CanCreate":"string", "CanDelete":"string", "CanEdit":"string", "CanView":"string", "Constituency":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "UserGroup":{"Id":"string"}}`),
...
var Post_Organizations_cmd = &cobra.Command{
		Use: `Organizations`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "LicenseeAccountCode":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Origins_cmd = &cobra.Command{
		Use: `Origins`,
		Example: tq.JSONHighlight(`{"ActivityType":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_PackagePriceTypes_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "PackageId":123, "PriceTypeId":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_PackageWebContents_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ContentType":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "PackageId":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "Value":"string"}`),
...
var Post_PaymentComponent_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"Amount":123.456, "CardBrandsToInclude":["", ...], "ComponentVersion":"string", "ConstituentId":123, "MerchantId":"string", "ShowStoredCards":true}`),
...
var Post_PaymentGatewayAccounts_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ConstituentId":123, "ReferenceNumber":"string"}`),
...
var Post_PaymentGatewayCredentials_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ConstituentId":123, "MerchantId":"string"}`),
		Short: ``,
		Long:  ``,
		PreRunE: initTq,
		RunE: func(cmd *cobra.Command, args []string) (err error) {
...
var Post_PaymentMethodGroups_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "MerchantId":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_PaymentMethodUserGroups_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "IncomeIndicator":true, "MaxRefund":123.456, "PaymentMethod":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "UserGroupId":"string"}`),
...
var Post_PaymentSignatures_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"Id":123}`),
...
var Post_Payments_cmd = &cobra.Command{
		Use: `Payments`,
		Example: tq.JSONHighlight(`{"Increment":123}`),
...
var Post_PerformanceGroups_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "DisplayByZone":true, "Facility":{"Id":123}, "FixedSeatIndicator":true, "Id":123, "Season":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "ZoneMap":{"Id":123}}`),
...
var Post_PerformancePackageModeOfSales_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"AutoAttend":"string", "ETicketReleaseDateTime":"2000-01-01T00:00:00.000Z", "EndDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "ModeOfSaleId":123, "PackageId":123, "PerformanceId":123, "PrintIndicator":true, "PrintOnAutoAttend":true, "SeatIndicator":true, "StartDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_PerformancePrices_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"EditIndicator":true, "EffectiveDateTime":"2000-01-01T00:00:00.000Z", "Enabled":true, "HasEvents":true, "Id":123, "IsPriceBasedOnCurrentEvent":true, "MinPrice":123.456, "PerformanceId":123, "PerformancePriceTypeId":123, "Price":123.456, "ZoneId":123}`),
...
var Post_PerformanceTypes_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "ValidCountryList":"string"}`),
...
var Post_Performances_cmd = &cobra.Command{
		Use: `Performances`,
		Example: tq.JSONHighlight(`{"PerformanceID":"string", "HoldCodeId":123, "HoldUntilDate":"2000-01-01T00:00:00.000Z", "ReplaceMode":123, "SeatID":"string"}`),
...
var Post_PhoneTypes_cmd = &cobra.Command{
		Use: `PhoneTypes`,
		Example: tq.JSONHighlight(`{"AllowMarketing":true, "ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DayEveningIndicator":"string", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_PlanPriorities_cmd = &cobra.Command{
		Use: `PlanPriorities`,
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "Ranking":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_PlanStatuses_cmd = &cobra.Command{
		Use: `PlanStatuses`,
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "Rank":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_PlanWorkers_cmd = &cobra.Command{
		Use: `PlanWorkers`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EditIndicator":true, "Id":123, "Plan":{"Id":123}, "PrimaryIndicator":true, "Role":{"Id":123}, "ShowInPortfolio":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "Worker":{"Id":123}}`),
...
var Post_PortfolioCustomElements_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DataType":123, "Description":"string", "Id":123, "Inactive":true, "SqlQuery":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_PriceCategories_cmd = &cobra.Command{
		Use: `PriceCategories`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "Rank":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_PriceLayerTypes_cmd = &cobra.Command{
		Use: `PriceLayerTypes`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "ExcludeFromRules":true, "Id":123, "Inactive":true, "PriceCategory":{"Id":123}, "Rank":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_PriceTypeCategories_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "ShortDescription":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_PriceTypeReasons_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "ShortDescription":"string", "TicketText":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_PriceTypeUserGroups_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "PriceType":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "UserGroupId":"string"}`),
...
var Post_PricingRuleSets_cmd = &cobra.Command{
		Use: `PricingRuleSets`,
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "EditIndicator":true, "Id":123, "Inactive":true, "Rules":[{"Id":123}, ...], "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Printers_cmd = &cobra.Command{
		Use: `Printers`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "MaxCol":123, "MaxRow":123, "MaxX2val":123, "MaxY2val":123, "Type":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ProductionSeasonMembershipOrganizations_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"AllowMultipleEntry":true, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "MembershipOrganization":{"Id":123}, "ProductionSeason":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Products_cmd = &cobra.Command{
		Use: `Products`,
		Example: tq.JSONHighlight(`{"PackageIds":"string", "PackageTypeIds":"string", "PerformanceIds":"string", "ProductionSeasonIds":"string"}`),
...
var Post_ProgramListings_cmd = &cobra.Command{
		Use: `ProgramListings`,
		Example: tq.JSONHighlight(`{"Constituent":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DonationLevel":{"Id":123}, "EditIndicator":true, "Id":123, "ProgramName":"string", "ProgramType":{"Id":123}, "SortName":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Programs_cmd = &cobra.Command{
		Use: `Programs`,
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Qualifications_cmd = &cobra.Command{
		Use: `Qualifications`,
		Example: tq.JSONHighlight(`{"Category":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_QueryElementGroups_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"Category":123, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DataFrom":"string", "DataWhere":"string", "Description":"string", "Id":123, "IsVirtual":true, "NumberOfParameters":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Rankings_cmd = &cobra.Command{
		Use: `Rankings`,
		Example: tq.JSONHighlight(`{"Constituent":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EditIndicator":true, "Id":123, "Rank":123, "RankType":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_RecordAttendance_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"OverrideDoorsOpen":true, "ProfileId":123, "TicketNo":123}`),
...
var Post_ReferenceTableUserGroups_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CanEdit":true, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "ReferenceTable":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "UserGroupId":"string"}`),
...
var Post_RelationshipCategories_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ReportSchedules_cmd = &cobra.Command{
		Use: `ReportSchedules`,
		Example: tq.JSONHighlight(`{"DayOfWeek":123, "DayWeekNumber":123, "EndDate":"2000-01-01T00:00:00.000Z", "EndTime":"2000-01-01T00:00:00.000Z", "Interval":123, "StartDate":"2000-01-01T00:00:00.000Z", "StartTime":"2000-01-01T00:00:00.000Z", "Type":"string"}`),
...
var Post_ReportUserGroups_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "ReportId":"string", "RunRight":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "UserGroupId":"string", "ViewRight":"string"}`),
...
var Post_Reports_cmd = &cobra.Command{
		Use: `Reports`,
		Example: tq.JSONHighlight(`{"ParameterName":"string", "ReportId":"string", "WhereDependencies":[{"ParameterId":"string"}, ...]}`),
...
var Post_Research_cmd = &cobra.Command{
		Use: `Research`,
		Example: tq.JSONHighlight(`{"Constituent":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EditIndicator":true, "Id":123, "ResearchDate":"2000-01-01T00:00:00.000Z", "ResearchSource":"string", "ResearchType":{"Id":123}, "Researcher":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_SeasonTypes_cmd = &cobra.Command{
		Use: `SeasonTypes`,
		Example: tq.JSONHighlight(`{"BusinessUnit":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_SeatCodes_cmd = &cobra.Command{
		Use: `SeatCodes`,
		Example: tq.JSONHighlight(`{"BackColor":123, "Context":"string", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "DisplayLetter":"string", "ForeColor":123, "Id":123, "Inactive":true, "IsSeat":123, "TicketText":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_SeatStatuses_cmd = &cobra.Command{
		Use: `SeatStatuses`,
		Example: tq.JSONHighlight(`{"BackColor":123, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "ForeColor":123, "Id":123, "Inactive":true, "StatusCode":"string", "StatusLegend":"string", "StatusPriority":123, "Tck":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Sections_cmd = &cobra.Command{
		Use: `Sections`,
		Example: tq.JSONHighlight(`{"AdditionalText":"string", "AdditionalText2":"string", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "PrintDesc":"string", "PrintSequence":123, "SectionLegend":"string", "ShortDesc":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ServiceResourceUserGroups_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CanCreate":true, "CanDelete":true, "CanRead":true, "CanUpdate":true, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "ServiceResource":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "UserGroupId":"string"}`),
...
var Post_Session_cmd = &cobra.Command{
		Use: `Session`,
		Example: tq.JSONHighlight(`{"SessionKey":"string", "Name":"string", "Value":"string"}`),
...
var Post_SpecialActivities_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ConstituentId":123, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "Notes":"string", "NumberOfAttendees":123, "Performance":"string", "SpecialActivityDateTime":"2000-01-01T00:00:00.000Z", "Status":{"Id":123}, "Type":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "WorkerConstituentId":123}`),
...
var Post_States_cmd = &cobra.Command{
		Use: `States`,
		Example: tq.JSONHighlight(`{"Country":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "StateCode":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_SubLineItemStatuses_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "Priority":123, "StatusCode":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_SurveyResponses_cmd = &cobra.Command{
		Use: `SurveyResponses`,
		Example: tq.JSONHighlight(`{"Answer":"string", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "OrderId":123, "QuestionId":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_TemplateCategories_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "EditIndicator":true, "Id":123, "Inactive":true, "Type":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_TemplatePriceTypes_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DesignationCode":{"Id":123}, "GlAccount":{"Id":123}, "Id":123, "PriceTemplate":{"Id":123}, "PriceType":{"Id":123}, "ResaleAccount":{"Id":123}, "TemplatePrices":[{"Id":123}, ...], "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_TemplatePrices_cmd = &cobra.Command{
		Use: `TemplatePrices`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EditIndicator":true, "Enabled":true, "Id":123, "MinPrice":123.456, "Price":123.456, "TemplatePriceType":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "Zone":{"Id":123}}`),
...
var Post_Templates_cmd = &cobra.Command{
		Use: `Templates`,
		Example: tq.JSONHighlight(`{"Category":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "EditIndicator":true, "Id":123, "Inactive":true, "IsHtmlBody":true, "TemplateBody":"string", "TemplateSubject":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_TimeSlots_cmd = &cobra.Command{
		Use: `TimeSlots`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "EndTime":"2000-01-01T00:00:00.000Z", "Id":123, "Inactive":true, "StartTime":"2000-01-01T00:00:00.000Z", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_TriPOSCloudConfigurations_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"ConfigSetting":"string", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_UpgradeLogs_cmd = &cobra.Command{
		Use: `UpgradeLogs`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "HotFixNumber":123, "Id":123, "ReleaseDescription":"string", "ScriptId":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "UpgradeCategorySummary":{"Id":123}, "Version":"string"}`),
...
var Post_UserPreferences_cmd = &cobra.Command{
		Use: `UserPreferences`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "Key":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "Value":"string"}`),
...
var Post_Users_cmd = &cobra.Command{
		Use: `Users`,
		Example: tq.JSONHighlight(`{"NewPassword":"string", "OldPassword":"string", "UserName":"string"}`),
...
var Post_ValidateWebLogin_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"LoginName":"string", "LoginTypeId":123, "Password":"string"}`),
...
var Post_WorkerQualifications_cmd = &cobra.Command{
		...
		Example: tq.JSONHighlight(`{"Constituent":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EndDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "Qualification":{"Id":123}, "StartDateTime":"2000-01-01T00:00:00.000Z", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_WorkerRoles_cmd = &cobra.Command{
		Use: `WorkerRoles`,
		Example: tq.JSONHighlight(`{"ControlGroup":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "ShowInPortfolioDefault":true, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_Workers_cmd = &cobra.Command{
		Use: `Workers`,
		Example: tq.JSONHighlight(`{"ConstituentId":123, "ConstituentInactive":{"Id":123}, "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EditIndicator":true, "FirstName":"string", "Id":123, "Inactive":true, "LastName":"string", "Prefix":{"Id":123}, "ShortDisplayName":"string", "SortName":"string", "Suffix":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "WorkerType":{"Id":123}}`),
...
var Post_ZoneGroups_cmd = &cobra.Command{
		Use: `ZoneGroups`,
		Example: tq.JSONHighlight(`{"AliasDescription":"string", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "Rank":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
var Post_ZoneMaps_cmd = &cobra.Command{
		Use: `ZoneMaps`,
		Example: tq.JSONHighlight(`{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "Id":123, "Inactive":true, "SeatMap":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`),
...
func init() {
		...
		Post_cmd.AddCommand(Post_Accounts_cmd) 
				Post_Accounts_cmd.Flags().Bool("DirectDebitAccount", false, 
					`Store a direct debit account.` + "\nQuery:\n" + tq.JSONHighlight(`{"AccountNumber":"string", "CardExpiryMonth":123, "CardExpiryYear":123, "ConstituentId":123, "DirectDebitAccountType":{"Id":123}, "Inactive":true, "Name":"string"}`) + "\n") 
				Post_Accounts_cmd.Flags().Bool("SepaAccount", false, 
					`Store a SEPA Direct Debit account.` + "\nQuery:\n" + tq.JSONHighlight(`{"AccountNumber":"string", "BankIdentifierCode":"string", "ConstituentId":123, "Inactive":true, "MandateNumber":"string", "MandateType":123, "Name":"string", "SignatureDate":"2000-01-01T00:00:00.000Z"}`) + "\n") 
				Post_Accounts_cmd.Flags().Bool("VantivEncryptedCardAccount", false, 
					`Create a credit card account from a Vantiv Encrypted Reader using tokenization.` + "\nQuery:\n" + tq.JSONHighlight(`{"ConstituentId":123, "ExclusiveToControlledBatchId":123, "Inactive":true, "Name":"string", "PaymentMethodGroupId":123, "VantivEncryptedCard":{"Version":"string"}}`) + "\n")
...
Create a payment link to a hosted payment form where shoppers can pay.  For Tessitura Merchant Services only.` + "\nQuery:\n" + tq.JSONHighlight(`{"AllowedPaymentMethods":["", ...], "Amount":123.456, "ConstituentId":123, "CountryCode":"string", "Currency":"string", "Description":"string", "IsECommerce":true, "LinkExpiry":"2000-01-01T00:00:00.000Z", "Locale":"string", "MerchantId":"string", "PaymentId":123, "StoreAccount":true, "TransactionOrigin":"string"}`) + "\n") 
		...
		Post_cmd.AddCommand(Post_Bookings_cmd) 
				Post_Bookings_cmd.Flags().Bool("AddDocument", false, 
					`Add a document to the booking.` + "\nQuery:\n" + tq.JSONHighlight(`{"BookingID":"string", "Category":{"Id":123}, "ConstituentId":123, "Contents":"AA==", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "FileName":"string", "Id":123, "Notes":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}`) + "\n") 
				Post_Bookings_cmd.Flags().Bool("FromTemplate", false, 
					`Create a new Booking using the details and Resource Type assignments from a Booking Template.` + "\nQuery:\n" + tq.JSONHighlight(`{"BookingSource":123, "BookingTemplateId":123, "ConfirmationText":"string", "DefaultCount":123, "DefaultDateTime":"2000-01-01T00:00:00.000Z", "DefaultDuration":123, "Description":"string", "Notes":"string"}`) + "\n")
	
		Post_cmd.AddCommand(Post_BulkCopySets_cmd) 
				Post_BulkCopySets_cmd.Flags().Bool("CopyDay", false, 
					`Copies the packages, performances groups and performances from a day defined in the bulk copy set to the day specified in the request.` + "\nQuery:\n" + tq.JSONHighlight(`{"CopyToDate":"2000-01-01T00:00:00.000Z", "PackageCodeCounter":123, "PerformanceCodeCounter":123, "BulkCopySetID":"string"}`) + "\n") 
				Post_BulkCopySets_cmd.Flags().Bool("CopyEvent", false, 
					`Copies the performance specified in the bulk copy set to the date and time specified in the request.` + "\nQuery:\n" + tq.JSONHighlight(`{"CopyToDate":"2000-01-01T00:00:00.000Z", "PerformanceCodeCounter":123, "BulkCopySetID":"string"}`) + "\n") 
				Post_BulkCopySets_cmd.Flags().Bool("ReplaceExclusions", false, 
					`Replaces bulk copy exclusions for a given set by deleting them and inserting the new collection.` + "\nQuery:\n" + tq.JSONHighlight(`{"BulkCopySetID":"string", "BulkDailyCopyExclusions":[{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DoNotCopy":true, "Id":123, "IncludeWithoutCopy":true, "PackageId":123, "PerformanceId":123, "SetId":123, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}, ...]}`) + "\n")
...
This method will allow the reservation of held seats.To enable this functionality, add the key ''Reserve Held Seats' to T_DEFAULTS with a value of 'Yes' under the "Tessitura Web" parent table (or organization name if operating in a consortium environment).` + "\nQuery:\n" + tq.JSONHighlight(`{"LeaveSingleSeats":true, "NumberOfSeats":123, "PackageId":123, "ParentPackageLineItemId":123, "PriceType":"string", "PriceTypeReason":"string", "RequestedSeats":"string", "Unseated":true, "ZoneId":123, "SessionKey":"string"}`) + "\n") 
...
The number of payments, payment amounts, and payment due dates are calculated based on the selected billing schedule.  For details on setting up billing schedules see the TR_BILLING_SCHEDULE section of the System Tables document.` + "\nQuery:\n" + tq.JSONHighlight(`{"AccountId":123, "BillingScheduleId":123, "BillingTypeId":123, "Card":{"ExpiryMonth":123, "ExpiryYear":123, "Name":"string", "Number":"string", "PaymentMethodGroupId":123}, "EndDate":"2000-01-01T00:00:00.000Z", "OverrideAmountToSchedule":123.456, "StartDate":"2000-01-01T00:00:00.000Z", "SessionKey":"string"}`) + "\n") 
...
Not valid for a general public cart.` + "\nQuery:\n" + tq.JSONHighlight(`{"Amount":123.456, "Notes":"string", "PaymentMethodId":123, "SessionKey":"string"}`) + "\n") 
				...
				Post_Cart_cmd.Flags().Bool("Authorize", false, 
					`Authorize payment using a card reader in a web based transaction.` + "\nQuery:\n" + tq.JSONHighlight(`{"Amount":123.456, "IsMoto":true, "MachineId":123, "TransactionOrigin":"string", "UserData":"string", "SessionKey":"string"}`) + "\n") 
...
In order to facilitate the use of the interceptor capability, the checkout method now makes a POST call to Txn / Orders.By default this call does nothing unless a developer has added interceptor plug -in code to the exposure.` + "\nQuery:\n" + tq.JSONHighlight(`{"AccountId":123, "Address":"string", "AllowUnderPayment":true, "Amount":123.456, "AuthorizationCode":"string", "Authorize":true, "CreditCardAuthenticationCode":"string", "CreditCardMonth":123, "CreditCardNumber":"string", "CreditCardOwner":"string", "CreditCardType":123, "CreditCardYear":123, "DeliveryDate":"2000-01-01T00:00:00.000Z", "ECommerce":true, "PaymentId":123, "PaymentReference":"string", "SecureValues":"string", "StoreAccount":true, "ZipCode":"string", "SessionKey":"string"}`) + "\n") 
 ...
 When the method is run the status of the order is checked to ensure checkout has not started. The procedure will set the status in T_WEB_CHECKOUT to one of the following values: (S)ave in progress, (C)ompleted save, (E)rror when saving.
The response includes a status and message details about the status.Possible status results are: SaveInProgress, SaveComplete, Error.
In order to facilitate the use of the interceptor capability, the checkout method now makes a POST call to Txn / Orders.By default this call does nothing unless a developer has added interceptor plug -in code to the exposure.` + "\nQuery:\n" + tq.JSONHighlight(`{"AllowUnderPayment":true, "Amount":123.456, "AuthorizationCode":"string", "Authorize":true, "CreditCardTrack1":"string", "CreditCardTrack2":"string", "CreditCardType":123, "DeliveryDate":"2000-01-01T00:00:00.000Z", "ECommerce":true, "StoreAccount":true, "ZipCode":"string", "SessionKey":"string"}`) + "\n") 
...
The number of payments, payment amounts, and payment due dates are calculated based on the selected billing schedule.  For details on setting up billing schedules see the TR_BILLING_SCHEDULE section of the System Tables document.` + "\nQuery:\n" + tq.JSONHighlight(`{"BillingScheduleId":123, "EndDate":"2000-01-01T00:00:00.000Z", "OverrideAmountToSchedule":123.456, "StartDate":"2000-01-01T00:00:00.000Z", "SessionKey":"string"}`) + "\n") 
...
If PrinterType = "B", ticket designs with images are not supported` + "\nQuery:\n" + tq.JSONHighlight(`{"ReceiptSettingsID":"string", "HeaderDesignId":123, "IncludeReceipts":true, "LineItems":"string", "Mode":123, "NewTicketNoForReprints":true, "OrderId":123, "PrinterType":"string", "ReprintTickets":true, "SubLineItems":"string", "TicketDesignId":123, "SessionKey":"string"}`) + "\n") 
...
The method returns tickets for unprinted fully-paid orders or reprints printed tickets specified via order number, one or more line item numbers, or one or more sub line item numbers.  In the case of partially-paid orders, only line items or sub line items which have been fully-paid will be eligible for printing. Only tickets belonging to the customer associated via the current web session can be returned. Ticket information can be returned in the default design specified for the ticket price type, or you may specify a ticket design to utilize via the request parameters. After the tickets have been returned via the API, seats will be flagged as Ticketed in Tessitura.
When reprinting tickets, one of the request parameters provides you with the option to regenerate the ticket number or reuse the current ticket number.` + "\nQuery:\n" + tq.JSONHighlight(`{"HeaderDesignId":123, "IncludeReceipts":true, "LineItems":"string", "Mode":123, "NewTicketNoForReprints":true, "OrderId":123, "PrinterType":"string", "ReprintTickets":true, "SubLineItems":"string", "TicketDesignId":123, "SessionKey":"string"}`) + "\n") 
...
This method will allow the reservation of held seats.To enable this functionality, add the key ''Reserve Held Seats' to T_DEFAULTS with a value of 'Yes' under the "Tessitura Web" parent table (or organization name if operating in a consortium environment).` + "\nQuery:\n" + tq.JSONHighlight(`{"NumberOfSeats":123, "PerformanceId":123, "PriceType":"string", "PriceTypeReason":"string", "RequestedSeats":"string", "SpecialRequests":"string", "Unseated":true, "ZoneId":123, "SessionKey":"string"}`) + "\n") 
				Post_Cart_cmd.Flags().Bool("ReserveTicketsForLineItem", false, 
					`Reserves tickets in cart for an existing line item
PerformanceId specified must be valid for the line item` + "\nQuery:\n" + tq.JSONHighlight(`{"LineItemID":"string", "NumberOfSeats":123, "PerformanceId":123, "PriceType":"string", "PriceTypeReason":"string", "RequestedSeats":"string", "SpecialRequests":"string", "Unseated":true, "ZoneId":123, "SessionKey":"string"}`) + "\n") 
...
To enable ticket limit validation, add the Field Name "ENFORCE_SEAT_LIMIT_FOR_ORDERS" under the "Impresario" parent table with a value of "Yes." This setting applies to both the Web API and the Tessitura Client Application.` + "\nQuery:\n" + tq.JSONHighlight(`{"PackageId":123, "PerformanceId":123, "PriceTypeId":123, "SeatCount":123, "SessionKey":"string"}`) + "\n")
		...
		Post_cmd.AddCommand(Post_EMV_cmd) 
				Post_EMV_cmd.Flags().Bool("Lane", false, 
					`Add a new lane to merchant` + "\nQuery:\n" + tq.JSONHighlight(`{"Cert":"string", "ActivationCode":"string", "Description":"string", "LaneId":"string", "MarketCode":"string", "TerminalId":"string", "Merchant":"string"}`) + "\n") 
				Post_EMV_cmd.Flags().Bool("Signature", false, 
					`Accepts the signature for a Payment Express HIT authorization.` + "\nQuery:\n" + tq.JSONHighlight(`{"MachineId":123, "PaymentId":123, "SignatureMatches":true, "StoreAccount":true}`) + "\n") 
				Post_EMV_cmd.Flags().Bool("Token", false, 
					`Creates a token on the specified constituent via a Payment Express HIT, TriPOSCloud, or Adyen device without authorizing a transaction.` + "\nQuery:\n" + tq.JSONHighlight(`{"ConstituentId":123, "IsMoto":true, "MachineId":123, "TransactionOrigin":"string"}`) + "\n")
		...
		Post_cmd.AddCommand(Post_Emails_cmd) 
				Post_Emails_cmd.Flags().Bool("SendConstituentInfo", false, 
					`Queues a Constituents Info email` + "\nQuery:\n" + tq.JSONHighlight(`{"ConstituentID":"string", "EmailAddress":"string", "EmailProfileId":123, "NameValues":[{"Name":"string", "Value":"string"}, ...], "TemplateId":123}`) + "\n") 
...
Use the SendCredentials endpoint in Web/Session to send a login credentials email with a generated password token.` + "\nQuery:\n" + tq.JSONHighlight(`{"LoginID":"string", "EmailAddress":"string", "EmailProfileId":123, "NameValues":[{"Name":"string", "Value":"string"}, ...], "TemplateId":123}`) + "\n") 
				Post_Emails_cmd.Flags().Bool("SendOrderConfirmation", false, 
					`Queues an Order Confirmation email` + "\nQuery:\n" + tq.JSONHighlight(`{"OrderID":"string", "EmailAddress":"string", "EmailProfileId":123, "NameValues":[{"Name":"string", "Value":"string"}, ...], "TemplateId":123}`) + "\n") 
				Post_Emails_cmd.Flags().Bool("SendTickets", false, 
					`Queues a ticket email` + "\nQuery:\n" + tq.JSONHighlight(`{"OrderID":"string", "EmailAddress":"string", "EmailProfileId":123, "PrintOrderTicketsRequest":{"BatchId":123, "HeaderDesignId":123, "IncludeReceipts":true, "LineItems":"string", "NewTicketNoForReprints":true, "PrinterType":"string", "ReprintTickets":true, "SubLineItems":"string", "TicketDesignId":123}, "TemplateId":123}`) + "\n")
...
When reprinting tickets, one of the request parameters provides you with the option to regenerate the ticket number or reuse the current ticket number.
Composite tickets are not currently supported, so a request to print one will instead return ticket elements for each performance, as if no composite ticket design had been selected for the package.` + "\nQuery:\n" + tq.JSONHighlight(`{"OrderID":"string", "BatchId":123, "HeaderDesignId":123, "IncludeReceipts":true, "LineItems":"string", "NewTicketNoForReprints":true, "PrinterType":"string", "ReprintTickets":true, "SubLineItems":"string", "TicketDesignId":123}`) + "\n")
		...
		Post_cmd.AddCommand(Post_PaymentSignatures_cmd) 
				Post_PaymentSignatures_cmd.Flags().Bool("PostForOrder", false, 
					`Create a new payment signature.` + "\nQuery:\n" + tq.JSONHighlight(`{"OrderID":"string", "Id":123}`) + "\n")
		...
		Post_cmd.AddCommand(Post_PerformancePriceLayers_cmd) 
				Post_PerformancePriceLayers_cmd.Flags().Bool("PostSummaries", false, 
					`Create/Update the prices for a set of performances.` + "\nQuery:\n" + tq.JSONHighlight(`{"Layers":[{"DefaultDesignationCodeId":123, "DefaultGlAccountId":123, "DefaultResaleAccountId":123, "Description":"string", "EffectiveDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "PerformanceId":123, "PerformancePriceTypes":[{"Id":123}, ...], "PriceLayerTypeId":123, "TemplateId":123}, ...]}`) + "\n") 
				Post_PerformancePriceLayers_cmd.Flags().Bool("Search", false, 
					`Get all performance price layers for the list of performances. Only one of AsOfDateTime or AsOfRelativeDate can be specified to get prices effective for that date time.` + "\nQuery:\n" + tq.JSONHighlight(`{"AsOfDateTime":"string", "AsOfRelativeDate":"string", "PerformanceIds":"string"}`) + "\n") 
		...
		Post_cmd.AddCommand(Post_Performances_cmd) 
				...
				Post_Performances_cmd.Flags().Bool("Reschedule", false, 
					`Reschedules an existing performance according to the provided options` + "\nQuery:\n" + tq.JSONHighlight(`{"Campaign":{"Id":123}, "Code":"string", "DateTime":"2000-01-01T00:00:00.000Z", "DefaultSaleDateOption":123, "Id":123, "ModeOfSaleDateOption":123, "OffersDateOption":123, "PriceEventDateOption":123, "PriceTypeDateOption":123, "ProductionSeasonId":123, "PublishDateOption":123, "TimeSlotId":123}`) + "\n") 
...
Can be used to add or remove holds from seats for the specified performance. Specifying a hold code of -1 for a seat will remove all hold codes from that seat.` + "\nQuery:\n" + tq.JSONHighlight(`{"PerformanceID":"string", "HoldUntilDate":"2000-01-01T00:00:00.000Z", "OnlyAffectAvailable":true, "ReplaceMode":123, "SeatHolds":[{"HoldCodeId":123, "SeatId":123}, ...]}`) + "\n")
		...
		Post_cmd.AddCommand(Post_Resources_cmd) 
				Post_Resources_cmd.Flags().Bool("FindAvailableResources", false, 
					`Get a set of resources available at the requested time/count/qualifications.` + "\nQuery:\n" + tq.JSONHighlight(`{"EndDateTime":"2000-01-01T00:00:00.000Z", "QualificationIds":"string", "ResourceCount":123, "ResourceTypeId":123, "StartDateTime":"2000-01-01T00:00:00.000Z"}`) + "\n") 
				Post_Resources_cmd.Flags().Bool("ScheduleOccurrences", false, 
					`Get schedule occurrences for set of resources and/or constituents during certain period of time.` + "\nQuery:\n" + tq.JSONHighlight(`{"ConstituentIds":"string", "EndDateTime":"2000-01-01T00:00:00.000Z", "ExpandWorkerAssignments":true, "ResourceIds":"string", "ResourceTypeIds":"string", "StartDateTime":"2000-01-01T00:00:00.000Z"}`) + "\n")
...
A source number and mode of sale must be supplied. An optional valid batch id may be included.` + "\nQuery:\n" + tq.JSONHighlight(`{"BusinessUnit":123, "IpAddress":"string", "Organization":"string", "SessionInfo":{"BatchId":123, "ModeOfSaleId":123, "PromotionCode":123}}`) + "\n") 
...
- UserName -- The username for the session
- Status -- The status of the login (P = permanent, T = temporary)
A constituent can be locked out of logging in after a certain number of failed log in attempts.  The number of failed attempts before lockout and the length of lockout are set in the T_DEFAULTS table.  Should a constituent exceed the allowed number of failed log in attempts, the method returns data on the number of failed login attempts per login along with a timestamp of the time at which the user was locked out of the login process.` + "\nQuery:\n" + tq.JSONHighlight(`{"ConstituentId":123, "EmailAddress":"string", "LoginTypeId":123, "PhoneNumber":"string", "PostalCode":"string", "PromotionCode":123, "SessionKey":"string"}`) + "\n") 
...
- UserName -- The username for the session
- Status -- The status of the login (P = permanent, T = temporary)
A constituent can be locked out of logging in after a certain number of failed log in attempts.  The number of failed attempts before lockout and the length of lockout are set in the T_DEFAULTS table.  Should a constituent exceed the allowed number of failed log in attempts, the method returns data on the number of failed login attempts per login along with a timestamp of the time at which the user was locked out of the login process.` + "\nQuery:\n" + tq.JSONHighlight(`{"EmailAddress":"string", "LoginTypeId":123, "Password":"string", "PromotionCode":123, "SessionKey":"string"}`) + "\n") 
...
- UserName -- The username for the session
- Status -- The status of the login (P = permanent, T = temporary)
A constituent can be locked out of logging in after a certain number of failed log in attempts.  The number of failed attempts before lockout and the length of lockout are set in the T_DEFAULTS table.  Should a constituent exceed the allowed number of failed log in attempts, the method returns data on the number of failed login attempts per login along with a timestamp of the time at which the user was locked out of the login process.` + "\nQuery:\n" + tq.JSONHighlight(`{"LoginTypeId":123, "PromotionCode":123, "UserName":"string", "SessionKey":"string"}`) + "\n") 
...
- UserName -- The username for the session
- Status -- The status of the login (P = permanent, T = temporary)
A constituent can be locked out of logging in after a certain number of failed log in attempts.  The number of failed attempts before lockout and the length of lockout are set in the T_DEFAULTS table.  Should a constituent exceed the allowed number of failed log in attempts, the method returns data on the number of failed login attempts per login along with a timestamp of the time at which the user was locked out of the login process.` + "\nQuery:\n" + tq.JSONHighlight(`{"EmailAddress":"string", "ForgotLoginToken":"string", "LoginTypeId":123, "PromotionCode":123, "SessionKey":"string"}`) + "\n") 
 ...
 You can choose to have the web API automatically disconnect the constituent's session from the Seat Server once transfer session has completed by setting the configuration value of DISCONNECT_SEAT_SERVER_SESSION_WHEN_TRANSFERING_SESSION to True in the Web API config file.` + "\nQuery:\n" + tq.JSONHighlight(`{"NewSessionKey":"string", "SessionKey":"string"}`) + "\n") 
		...
		Post_cmd.AddCommand(Post_Steps_cmd) 
				Post_Steps_cmd.Flags().Bool("AddDocument", false, 
					`Add a document to the step.` + "\nQuery:\n" + tq.JSONHighlight(`{"Category":{"Id":123}, "ConstituentId":123, "Contents":"AA==", "CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Description":"string", "FileName":"string", "Id":123, "Notes":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "StepID":"string"}`) + "\n")
		...
		Post_cmd.AddCommand(Post_TemplatePriceTypes_cmd) 
				Post_TemplatePriceTypes_cmd.Flags().Bool("Batch", false, 
					`Create or update a set of template price types.` + "\nQuery:\n" + tq.JSONHighlight(`{"TemplatePriceTypes":[{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "DesignationCode":{"Id":123}, "GlAccount":{"Id":123}, "Id":123, "PriceTemplate":{"Id":123}, "PriceType":{"Id":123}, "ResaleAccount":{"Id":123}, "TemplatePrices":[{"Id":123}, ...], "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z"}, ...]}`) + "\n")
	
		Post_cmd.AddCommand(Post_TemplatePrices_cmd) 
				Post_TemplatePrices_cmd.Flags().Bool("Batch", false, 
					`Create or update a set of template prices.` + "\nQuery:\n" + tq.JSONHighlight(`{"TemplatePrices":[{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "EditIndicator":true, "Enabled":true, "Id":123, "MinPrice":123.456, "Price":123.456, "TemplatePriceType":{"Id":123}, "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "Zone":{"Id":123}}, ...]}`) + "\n")
	
		Post_cmd.AddCommand(Post_Templates_cmd) 
				Post_Templates_cmd.Flags().Bool("ConstituentInfo", false, 
					`Get a formatted html body for constituent info` + "\nQuery:\n" + tq.JSONHighlight(`{"ConstituentID":"string", "Request":[{"Name":"string", "Value":"string"}, ...], "TemplateID":"string"}`) + "\n") 
				Post_Templates_cmd.Flags().Bool("LoginCredentials", false, 
					`Get a formatted html body for login credentials.
This endpoint will not generate a password token and should be used for testing a login credentials template.
Use the SendCredentials endpoint in Web/Session to send a login credentials email with a generated password token.` + "\nQuery:\n" + tq.JSONHighlight(`{"LoginID":"string", "Request":[{"Name":"string", "Value":"string"}, ...], "TemplateID":"string"}`) + "\n") 
				Post_Templates_cmd.Flags().Bool("OrderConfirmation", false, 
					`Get a formatted html body for an order confirmation` + "\nQuery:\n" + tq.JSONHighlight(`{"OrderID":"string", "Request":[{"Name":"string", "Value":"string"}, ...], "TemplateID":"string"}`) + "\n") 
				Post_Templates_cmd.Flags().Bool("RenderConstituentInfo", false, 
					`Return the rendered constituent info template for the provided constituent Id` + "\nQuery:\n" + tq.JSONHighlight(`{"ConstituentID":"string", "Body":"string", "NameValues":[{"Name":"string", "Value":"string"}, ...]}`) + "\n") 
...
This endpoint will not generate a password token and should be used for testing a login credentials template.
Use the SendCredentials endpoint in Web/Session to send a login credentials email with a generated password token.` + "\nQuery:\n" + tq.JSONHighlight(`{"LoginID":"string", "Body":"string", "NameValues":[{"Name":"string", "Value":"string"}, ...]}`) + "\n") 
				Post_Templates_cmd.Flags().Bool("RenderOrderConfirmation", false, 
					`Return the rendered order confirmation template for the provided order Id` + "\nQuery:\n" + tq.JSONHighlight(`{"OrderID":"string", "Body":"string", "NameValues":[{"Name":"string", "Value":"string"}, ...]}`) + "\n") 
				Post_Templates_cmd.Flags().Bool("RenderTickets", false, 
					`Return the rendered tickets for the provided order Id
Composite tickets are not currently supported, so a request to print one will instead return ticket elements for each performance, as if no composite ticket design had been selected for the package.` + "\nQuery:\n" + tq.JSONHighlight(`{"OrderID":"string", "Body":"string", "PrintOrderTicketsRequest":{"BatchId":123, "HeaderDesignId":123, "IncludeReceipts":true, "LineItems":"string", "NewTicketNoForReprints":true, "PrinterType":"string", "ReprintTickets":true, "SubLineItems":"string", "TicketDesignId":123}}`) + "\n") 
				Post_Templates_cmd.Flags().Bool("Tickets", false, 
					`Get a formatted html body for tickets
Composite tickets are not currently supported, so a request to print one will instead return ticket elements for each performance, as if no composite ticket design had been selected for the package.` + "\nQuery:\n" + tq.JSONHighlight(`{"OrderID":"string", "BatchId":123, "HeaderDesignId":123, "IncludeReceipts":true, "LineItems":"string", "NewTicketNoForReprints":true, "PrinterType":"string", "ReprintTickets":true, "SubLineItems":"string", "TicketDesignId":123, "TemplateID":"string"}`) + "\n")
		...
		Post_cmd.AddCommand(Post_UserPreferences_cmd) 
				Post_UserPreferences_cmd.Flags().Bool("SaveBatch", false, 
					`Save a batch of user preferences.` + "\nQuery:\n" + tq.JSONHighlight(`{"UserPreferences":[{"CreateLocation":"string", "CreatedBy":"string", "CreatedDateTime":"2000-01-01T00:00:00.000Z", "Id":123, "Key":"string", "UpdatedBy":"string", "UpdatedDateTime":"2000-01-01T00:00:00.000Z", "Value":"string"}, ...]}`) + "\n")
		...
		Post_cmd.AddCommand(Post_Zones_cmd) 
				Post_Zones_cmd.Flags().Bool("Search", false, 
					`Search for products based on a set of criteria.` + "\nQuery:\n" + tq.JSONHighlight(`{"PackageIds":"string", "PackageTypeIds":"string", "PerformanceIds":"string", "ProductionSeasonIds":"string", "ZoneIds":"string"}`) + "\n")
